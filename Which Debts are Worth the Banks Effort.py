...
# Create the and durations lists
...
x = netflix_movies_col_subset['duration']
y = netflix_movies_col_subset['release_year']

plt.xlabel('Duration of Each Movie')
plt.ylabel('Release Year of Each Movie')
plt.scatter(x, y)
